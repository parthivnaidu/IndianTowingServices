                ...
                children: [
                  ...
                  SizedBox(
                   ...
                   InkWell(
                    onTap: () async {
                      String email =
                          Uri.encodeComponent("parthivlatchireddy@gmail.com");
                      String subject = Uri.encodeComponent("Indian Towing Service");
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(width: MediaQuery.of(context).size.width,
                            child: Text('Your Road To Rescue : We Got Your Back',
                                style: GoogleFonts.getFont('Poppins',
                                    fontSize: 15,
                                    shadows: [
                                      Shadow(
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  color:  Color.fromARGB(255, 14, 0, 91),
                ...
                children: [
                      ...
                      children: [
                       ...
                       SizedBox(
                          ...
                          child: Text(
                            ...
                            // 'Im a paragraph. Click here to add your own text and edit me. It’s easy. Just click “Edit Text” or double click me to add your own content and make changes to the font. I’m a great place for you to tell a story and let your users know a little more about you.',
                            ,
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                         Text(
                          'Luxary Vehicle Towing Service',textAlign: TextAlign.center,
                          style: TextStyle(
                              fontSize: 25,
                              fontWeight: FontWeight.bold,
                              shadows: [
                              ...
                              child: Column(
                                ...
                                (context, Constraints){
                                  if(i ==0 ){
                                    ...
                                    return  Text(
                                              'HEAVY VEHICLE TOWING SERVICE',textAlign: TextAlign.center,
                                              style: TextStyle(
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.bold,
                                                  shadows: [
                                    ...
                                    return  Text(
                                              'ACCDIENT VEHICLE RECOVERY',textAlign: TextAlign.center,
                                              style: TextStyle(
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.bold,
                                                  shadows: [
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        height: 50,
                        decoration: BoxDecoration(
                            color:  Color.fromARGB(255, 39, 27, 109),
                            shape: BoxShape.rectangle,
                            border: Border.all(
                              color:  Color.fromARGB(255, 39, 27, 109),
                            )),
